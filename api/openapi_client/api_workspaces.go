...
type WorkspacesAPI interface {
	...
	*/
	...
	/*
	WorkspacesScaleLandscapeServices scaleLandscapeServices
...
func (r ApiWorkspacesScaleLandscapeServicesRequest) RequestBody(requestBody map[string]int) ApiWorkspacesScaleLandscapeServicesRequest {
	r.requestBody = &requestBody
	return r
}

func (r ApiWorkspacesScaleLandscapeServicesRequest) Execute() (*http.Response, error) {
	return r.ApiService.WorkspacesScaleLandscapeServicesExecute(r)
}
...
// Execute executes the request
func (a *WorkspacesAPIService) WorkspacesScaleLandscapeServicesExecute(r ApiWorkspacesScaleLandscapeServicesRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesAPIService.WorkspacesScaleLandscapeServices")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/workspaces/{workspaceId}/landscape/scale"
	localVarPath = strings.Replace(localVarPath, "{"+"workspaceId"+"}", url.PathEscape(parameterValueToString(r.workspaceId, "workspaceId")), -1)
