...
func (o *ManagedServicesCreateProviderRequestAnyOf) GetBackend() ManagedServicesListProviders200ResponseInnerAnyOf1Backend {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ManagedServicesCreateProviderRequestAnyOf) GetBackendOk() (*ManagedServicesListProviders200ResponseInnerAnyOf1Backend, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ManagedServicesCreateProviderRequestAnyOf) SetBackend(v ManagedServicesListProviders200ResponseInnerAnyOf1Backend) {
	o.Backend = v
}

// GetScope returns the Scope field value if set, zero value otherwise.
func (o *ManagedServicesCreateProviderRequestAnyOf) GetScope() ManagedServicesUpsertProviderRequestAnyOfScope {
...
// and a boolean to check if the value has been set.
func (o *ManagedServicesCreateProviderRequestAnyOf) GetScopeOk() (*ManagedServicesUpsertProviderRequestAnyOfScope, bool) {
	if o == nil || IsNil(o.Scope) {
		return nil, false
	}
	return o.Scope, true
...
func (o *ManagedServicesCreateProviderRequestAnyOf) SetScope(v ManagedServicesUpsertProviderRequestAnyOfScope) {
	o.Scope = &v
}
