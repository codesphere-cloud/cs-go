...
// checks if the WorkspacesReplicaLogsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkspacesReplicaLogsGetResponse{}
...
type _WorkspacesReplicaLogsGetResponse WorkspacesReplicaLogsGetResponse

// NewWorkspacesReplicaLogsGetResponse instantiates a new WorkspacesReplicaLogsGetResponse object
...
func NewWorkspacesReplicaLogsGetResponse(data []WorkspacesLogsGetResponseDataInner, event string) *WorkspacesReplicaLogsGetResponse {
	this := WorkspacesReplicaLogsGetResponse{}
	this.Data = data
	this.Event = event
	return &this
}

// NewWorkspacesReplicaLogsGetResponseWithDefaults instantiates a new WorkspacesReplicaLogsGetResponse object
...
func (o *WorkspacesReplicaLogsGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = WorkspacesReplicaLogsGetResponse(varWorkspacesReplicaLogsGetResponse)

	return err
}

type NullableWorkspacesReplicaLogsGetResponse struct {
	value *WorkspacesReplicaLogsGetResponse
	isSet bool
}
...
func NewNullableWorkspacesReplicaLogsGetResponse(val *WorkspacesReplicaLogsGetResponse) *NullableWorkspacesReplicaLogsGetResponse {
	return &NullableWorkspacesReplicaLogsGetResponse{value: val, isSet: true}
}
