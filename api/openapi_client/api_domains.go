...
func (r ApiDomainsUpdateDomainRequest) DomainsUpdateDomainRequest(domainsUpdateDomainRequest DomainsUpdateDomainRequest) ApiDomainsUpdateDomainRequest {
	r.domainsUpdateDomainRequest = &domainsUpdateDomainRequest
	return r
}
...
func (a *DomainsAPIService) DomainsUpdateDomainExecute(r ApiDomainsUpdateDomainRequest) (*DomainsGetDomain200Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.domainsUpdateDomainRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
