...
type WorkspacesGetWorkspace200Response struct {
	...
	DevDomain *string `json:"devDomain,omitempty"`
...
func NewWorkspacesGetWorkspace200Response(teamId int, name string, planId int, isPrivateRepo bool, replicas int, id int, dataCenterId int, userId int, gitUrl NullableString, initialBranch NullableString, sourceWorkspaceId NullableInt, welcomeMessage NullableString, vpnConfig NullableString, restricted bool, collectTraces bool, persistentLogs bool, createdAt time.Time) *WorkspacesGetWorkspace200Response {
...
// GetDevDomain returns the DevDomain field value if set, zero value otherwise.
func (o *WorkspacesGetWorkspace200Response) GetDevDomain() string {
	if o == nil || IsNil(o.DevDomain) {
		var ret string
		return ret
	}
	return *o.DevDomain
...
// GetDevDomainOk returns a tuple with the DevDomain field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WorkspacesGetWorkspace200Response) GetDevDomainOk() (*string, bool) {
	if o == nil || IsNil(o.DevDomain) {
		return nil, false
	}
	return o.DevDomain, true
}

// HasDevDomain returns a boolean if a field has been set.
func (o *WorkspacesGetWorkspace200Response) HasDevDomain() bool {
	if o != nil && !IsNil(o.DevDomain) {
		return true
	}
...
// SetDevDomain gets a reference to the given string and assigns it to the DevDomain field.
func (o *WorkspacesGetWorkspace200Response) SetDevDomain(v string) {
	o.DevDomain = &v
}

// GetCreatedAt returns the CreatedAt field value
func (o *WorkspacesGetWorkspace200Response) GetCreatedAt() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WorkspacesGetWorkspace200Response) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WorkspacesGetWorkspace200Response) SetCreatedAt(v time.Time) {
	o.CreatedAt = v
}
...
func (o WorkspacesGetWorkspace200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DevDomain) {
		toSerialize["devDomain"] = o.DevDomain
	}
