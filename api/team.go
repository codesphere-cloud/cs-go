...
//
// Returns [NotFound] if no team with the given Id could be found
// Returns [Duplicated] if no team with the given Id could be found
func (client *Client) TeamIdByName(name string, orgId string) (Team, error) {
